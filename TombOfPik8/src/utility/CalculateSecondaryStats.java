...
public class CalculateSecondaryStats {
    ...
    public static int maxAttackResistanceByLevel(Hero hero)
    {
        ...
        if (!hero.getPrimeStats().isSpecialist())
        {
            ...
            if (hero.getPrimeStats().getStrengthLevel() <= STAIMNA_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_1_FOR_STRENGTH)
            {
                deltaLevel2 = hero.getPrimeStats().getStrengthLevel();
            }
            else if (hero.getPrimeStats().getStrengthLevel() <= STAIMNA_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_2_FOR_STRENGTH)
            {
                deltaLevel2 = hero.getPrimeStats().getStrengthLevel() - STAIMNA_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_1_FOR_STRENGTH;
                j = 1;
            }
            else
            {
                deltaLevel2 = hero.getPrimeStats().getStrengthLevel() - STAIMNA_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_2_FOR_STRENGTH;
                j = 2;
            }
        ...
        else
        {
            ...
            if (hero.getPrimeStats().getStrengthLevel() <= STAIMNA_RESISTANCE_SOFTCAP_SPEZIALISED_1_FOR_STRENGTH)
            {
                deltaLevel2 = hero.getPrimeStats().getStrengthLevel();
            }
            else if (hero.getPrimeStats().getStrengthLevel() <= STAIMNA_RESISTANCE_SOFTCAP_SPEZIALISED_2_FOR_STRENGTH)
            {
                deltaLevel2 = hero.getPrimeStats().getStrengthLevel() - STAIMNA_RESISTANCE_SOFTCAP_SPEZIALISED_1_FOR_STRENGTH;
                j = 1;
            }
            else
            {
                deltaLevel2 = hero.getPrimeStats().getStrengthLevel() - STAIMNA_RESISTANCE_SOFTCAP_SPEZIALISED_2_FOR_STRENGTH;
                j = 2;
            }
