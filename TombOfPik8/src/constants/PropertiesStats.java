...
public class PropertiesStats {
    ...
    public static int MAX_STAMINA_STARTVALUE_NOT_SPEZIALISED = 17;
    public static int MAX_STAMINA_SOFTCAP_NOT_SPEZIALISED_1 = 10;
    public static int MAX_STAMINA_SOFTCAP_NOT_SPEZIALISED_2 = 25;
    public static int MAX_STAMINA_SCALE_1_NOT_SPEZIALISED = 3;
    public static int MAX_STAMINA_SCALE_2_NOT_SPEZIALISED = 2;
    public static int MAX_STAMINA_SCALE_3_NOT_SPEZIALISED = 1;
    public static int MAX_STAMINA_MAX_VALUE_AFTER_SOFTCAP_1_NOT_SPEZIALISED = (MAX_STAMINA_SOFTCAP_NOT_SPEZIALISED_1 * MAX_STAMINA_SCALE_1_NOT_SPEZIALISED) + MAX_STAMINA_STARTVALUE_NOT_SPEZIALISED;
    public static int MAX_STAMINA_MAX_VALUE_AFTER_SOFTCAP_2_NOT_SPEZIALISED = ((MAX_STAMINA_SOFTCAP_NOT_SPEZIALISED_2 - MAX_STAMINA_SOFTCAP_NOT_SPEZIALISED_1) * MAX_STAMINA_SCALE_2_NOT_SPEZIALISED) + MAX_STAMINA_MAX_VALUE_AFTER_SOFTCAP_1_NOT_SPEZIALISED;

    public static int MAX_STAMINA_STARTVALUE_SPEZIALISED = 19;
    public static int MAX_STAMINA_SOFTCAP_SPEZIALISED_1 = 15;
    public static int MAX_STAMINA_SOFTCAP_SPEZIALISED_2 = 50;
    public static int MAX_STAMINA_SCALE_1_SPEZIALISED = 1;
    public static int MAX_STAMINA_SCALE_2_SPEZIALISED = 3;
    public static int MAX_STAMINA_SCALE_3_SPEZIALISED = 2;
    public static int MAX_STAMINA_MAX_VALUE_AFTER_SOFTCAP_1_SPEZIALISED = (MAX_STAMINA_SOFTCAP_SPEZIALISED_1 * MAX_STAMINA_SCALE_1_SPEZIALISED) + MAX_STAMINA_STARTVALUE_SPEZIALISED;
    public static int MAX_STAMINA_MAX_VALUE_AFTER_SOFTCAP_2_SPEZIALISED = ((MAX_STAMINA_SOFTCAP_SPEZIALISED_2 - MAX_STAMINA_SOFTCAP_SPEZIALISED_1 ) * MAX_STAMINA_SCALE_2_SPEZIALISED) + MAX_STAMINA_MAX_VALUE_AFTER_SOFTCAP_1_SPEZIALISED;

    //-----------STAIMNA_REGENERATION-----------STAIMNA_REGENERATION-----------STAIMNA_REGENERATION-----------STAIMNA_REGENERATION-----------STAIMNA_REGENERATION-----------STAIMNA_REGENERATION-----------STAIMNA_REGENERATION-----------STAIMNA_REGENERATION---------------

    public static int STAIMNA_REGENERATION_STARTVALUE_NOT_SPEZIALISED = 5;
    public static int STAIMNA_REGENERATION_SOFTCAP_NOT_SPEZIALISED_1 = 10;
    public static int STAIMNA_REGENERATION_SOFTCAP_NOT_SPEZIALISED_2 = 25;
    public static float STAIMNA_REGENERATION_SCALE_1_NOT_SPEZIALISED = 1f;
    public static float STAIMNA_REGENERATION_SCALE_2_NOT_SPEZIALISED = 0.5f;
    public static float STAIMNA_REGENERATION_SCALE_3_NOT_SPEZIALISED = (1 / 3);
    public static int STAIMNA_REGENERATION_MAX_VALUE_AFTER_SOFTCAP_1_NOT_SPEZIALISED = Math.round(STAIMNA_REGENERATION_SOFTCAP_NOT_SPEZIALISED_1 * STAIMNA_REGENERATION_SCALE_1_NOT_SPEZIALISED) + STAIMNA_REGENERATION_STARTVALUE_NOT_SPEZIALISED;
    public static int STAIMNA_REGENERATION_MAX_VALUE_AFTER_SOFTCAP_2_NOT_SPEZIALISED = Math.round((STAIMNA_REGENERATION_SOFTCAP_NOT_SPEZIALISED_2 - STAIMNA_REGENERATION_SOFTCAP_NOT_SPEZIALISED_1) * STAIMNA_REGENERATION_SCALE_2_NOT_SPEZIALISED) + STAIMNA_REGENERATION_MAX_VALUE_AFTER_SOFTCAP_1_NOT_SPEZIALISED;

    public static float[] STM_REGEN_SCALES_NOT_SPEZIALISED = { STAIMNA_REGENERATION_SCALE_1_NOT_SPEZIALISED, STAIMNA_REGENERATION_SCALE_2_NOT_SPEZIALISED, STAIMNA_REGENERATION_SCALE_3_NOT_SPEZIALISED };
    public static float[] STM_REGEN_BASESTATS_NOT_SPEZIALISED = { STAIMNA_REGENERATION_STARTVALUE_NOT_SPEZIALISED, STAIMNA_REGENERATION_MAX_VALUE_AFTER_SOFTCAP_1_NOT_SPEZIALISED, STAIMNA_REGENERATION_MAX_VALUE_AFTER_SOFTCAP_2_NOT_SPEZIALISED };

    public static int STAIMNA_REGENERATION_STARTVALUE_SPEZIALISED = 5;
    public static int STAIMNA_REGENERATION_SOFTCAP_SPEZIALISED_1 = 15;
    public static int STAIMNA_REGENERATION_SOFTCAP_SPEZIALISED_2 = 50;
    public static float STAIMNA_REGENERATION_SCALE_1_SPEZIALISED = 0.5f;
    public static float STAIMNA_REGENERATION_SCALE_2_SPEZIALISED = 1f;
    public static float STAIMNA_REGENERATION_SCALE_3_SPEZIALISED = 1.5f;
    public static int STAIMNA_REGENERATION_MAX_VALUE_AFTER_SOFTCAP_1_SPEZIALISED = Math.round(STAIMNA_REGENERATION_SOFTCAP_SPEZIALISED_1 * STAIMNA_REGENERATION_SCALE_1_SPEZIALISED) + STAIMNA_REGENERATION_STARTVALUE_SPEZIALISED;
    public static int STAIMNA_REGENERATION_MAX_VALUE_AFTER_SOFTCAP_2_HP_SPEZIALISED = Math.round((STAIMNA_REGENERATION_SOFTCAP_SPEZIALISED_2 - STAIMNA_REGENERATION_SOFTCAP_SPEZIALISED_1) * STAIMNA_REGENERATION_SCALE_2_SPEZIALISED) + STAIMNA_REGENERATION_MAX_VALUE_AFTER_SOFTCAP_1_SPEZIALISED;

    public static float[] STM_REGEN_SCALES_SPEZIALISED = { STAIMNA_REGENERATION_SCALE_1_SPEZIALISED, STAIMNA_REGENERATION_SCALE_2_SPEZIALISED, STAIMNA_REGENERATION_SCALE_3_SPEZIALISED };
    public static float[] STM_REGEN_BASESTATS_SPEZIALISED = { STAIMNA_REGENERATION_STARTVALUE_SPEZIALISED, STAIMNA_REGENERATION_MAX_VALUE_AFTER_SOFTCAP_1_SPEZIALISED, STAIMNA_REGENERATION_MAX_VALUE_AFTER_SOFTCAP_2_HP_SPEZIALISED };

    //-----------STAIMNA_RESISTANCE_FOR_TOUGHNESS-----------STAIMNA_RESISTANCE_FOR_TOUGHNESS-----------STAIMNA_RESISTANCE_FOR_TOUGHNESS-----------STAIMNA_RESISTANCE_FOR_TOUGHNESS-----------STAIMNA_RESISTANCE-----------STAIMNA_RESISTANCE-----------STAIMNA_RESISTANCE-----------STAIMNA_REGENERATION---------------

    public static int STAIMNA_RESISTANCE_STARTVALUE_NOT_SPEZIALISED_FOR_TOUGHNESS = 1;
    public static int STAIMNA_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_1_FOR_TOUGHNESS = 10;
    public static int STAIMNA_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_2_FOR_TOUGHNESS = 25;
    public static float STAIMNA_RESISTANCE_SCALE_1_NOT_SPEZIALISED_FOR_TOUGHNESS = 0.1f;
    public static float STAIMNA_RESISTANCE_SCALE_2_NOT_SPEZIALISED_FOR_TOUGHNESS = 0.1f;
    public static float STAIMNA_RESISTANCE_SCALE_3_NOT_SPEZIALISED_FOR_TOUGHNESS = 0.05f;
    public static int STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_NOT_SPEZIALISED_FOR_TOUGHNESS = Math.round(STAIMNA_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_1_FOR_TOUGHNESS * STAIMNA_RESISTANCE_SCALE_1_NOT_SPEZIALISED_FOR_TOUGHNESS) + STAIMNA_RESISTANCE_STARTVALUE_NOT_SPEZIALISED_FOR_TOUGHNESS;
    public static int STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_2_NOT_SPEZIALISED_FOR_TOUGHNESS = Math.round((STAIMNA_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_2_FOR_TOUGHNESS - STAIMNA_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_1_FOR_TOUGHNESS) * STAIMNA_RESISTANCE_SCALE_2_NOT_SPEZIALISED_FOR_TOUGHNESS) + STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_NOT_SPEZIALISED_FOR_TOUGHNESS;

    public static float[] STM_RESIS_SCALES_NOT_SPEZIALISED_FORTOUGHNESS = { STAIMNA_RESISTANCE_SCALE_1_NOT_SPEZIALISED_FOR_TOUGHNESS, STAIMNA_RESISTANCE_SCALE_2_NOT_SPEZIALISED_FOR_TOUGHNESS, STAIMNA_RESISTANCE_SCALE_3_NOT_SPEZIALISED_FOR_TOUGHNESS };
    public static int[] STM_RESIS_BASESTATS_NOT_SPEZIALISED_FORTOUGHNESS = { STAIMNA_RESISTANCE_STARTVALUE_NOT_SPEZIALISED_FOR_TOUGHNESS, STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_NOT_SPEZIALISED_FOR_TOUGHNESS, STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_2_NOT_SPEZIALISED_FOR_TOUGHNESS };

    public static int STAIMNA_RESISTANCE_STARTVALUE_SPEZIALISED_FOR_TOUGHNESS = 1;
    public static int STAIMNA_RESISTANCE_SOFTCAP_SPEZIALISED_1_FOR_TOUGHNESS = 10;
    public static int STAIMNA_RESISTANCE_SOFTCAP_SPEZIALISED_2_FOR_TOUGHNESS = 20;
    public static float STAIMNA_RESISTANCE_SCALE_1_SPEZIALISED_FOR_TOUGHNESS = 0f;
    public static float STAIMNA_RESISTANCE_SCALE_2_SPEZIALISED_FOR_TOUGHNESS = .1f;
    public static float STAIMNA_RESISTANCE_SCALE_3_SPEZIALISED_FOR_TOUGHNESS = 0.2f;
    public static int STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_SPEZIALISED_FOR_TOUGHNESS = STAIMNA_RESISTANCE_STARTVALUE_SPEZIALISED_FOR_TOUGHNESS;
    public static int STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_2_HP_SPEZIALISED_FOR_TOUGHNESS = Math.round((STAIMNA_RESISTANCE_SOFTCAP_SPEZIALISED_2_FOR_TOUGHNESS - STAIMNA_RESISTANCE_SOFTCAP_SPEZIALISED_1_FOR_TOUGHNESS) * STAIMNA_RESISTANCE_SCALE_2_SPEZIALISED_FOR_TOUGHNESS) + STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_SPEZIALISED_FOR_TOUGHNESS;

    public static float[] STM_RESIS_SCALES_SPEZIALISED_FORTOUGHNESS = { STAIMNA_RESISTANCE_SCALE_1_SPEZIALISED_FOR_TOUGHNESS, STAIMNA_RESISTANCE_SCALE_2_SPEZIALISED_FOR_TOUGHNESS, STAIMNA_RESISTANCE_SCALE_3_SPEZIALISED_FOR_TOUGHNESS };
    public static int[] STM_RESIS_BASESTATS_SPEZIALISED_FORTOUGHNESS = { STAIMNA_RESISTANCE_STARTVALUE_SPEZIALISED_FOR_TOUGHNESS, STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_SPEZIALISED_FOR_TOUGHNESS, STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_2_HP_SPEZIALISED_FOR_TOUGHNESS };

    //-----------STAIMNA_RESISTANCE_FOR_STRENGTH-----------STAIMNA_RESISTANCE_FOR_STRENGTH-----------STAIMNA_RESISTANCE_FOR_STRENGTH-----------STAIMNA_RESISTANCE_FOR_STRENGTH-----------STAIMNA_RESISTANCE-----------STAIMNA_RESISTANCE-----------STAIMNA_RESISTANCE-----------STAIMNA_REGENERATION---------------


    public static int STAIMNA_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_1_FOR_STRENGTH = 10;
    public static int STAIMNA_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_2_FOR_STRENGTH = 25;
    public static float STAIMNA_RESISTANCE_SCALE_1_NOT_SPEZIALISED_FOR_STRENGTH = 0.025f;
    public static float STAIMNA_RESISTANCE_SCALE_2_NOT_SPEZIALISED_FOR_STRENGTH = 0.05f;
    public static float STAIMNA_RESISTANCE_SCALE_3_NOT_SPEZIALISED_FOR_STRENGTH = 0.025f;
    public static float STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_NOT_SPEZIALISED_FOR_STRENGTH = STAIMNA_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_1_FOR_STRENGTH * STAIMNA_RESISTANCE_SCALE_1_NOT_SPEZIALISED_FOR_STRENGTH;
    public static float STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_2_HP_SPEZIALISED_FOR_STRENGTH = (STAIMNA_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_2_FOR_STRENGTH - STAIMNA_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_1_FOR_STRENGTH) * STAIMNA_RESISTANCE_SCALE_2_NOT_SPEZIALISED_FOR_STRENGTH + STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_NOT_SPEZIALISED_FOR_STRENGTH;

    public static float[] STM_RESIS_SCALES_NOT_SPEZIALISED_FOR_STREMGTH = { STAIMNA_RESISTANCE_SCALE_1_NOT_SPEZIALISED_FOR_STRENGTH, STAIMNA_RESISTANCE_SCALE_2_NOT_SPEZIALISED_FOR_STRENGTH, STAIMNA_REGENERATION_SCALE_3_SPEZIALISED };
    public static float[] STM_RESIS_BASES_NOT_SPEZIALISED_FOR_STREMGTH = { 0, STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_NOT_SPEZIALISED_FOR_STRENGTH, STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_2_HP_SPEZIALISED_FOR_STRENGTH };

    public static int STAIMNA_RESISTANCE_SOFTCAP_SPEZIALISED_1_FOR_STRENGTH = 10;
    public static int STAIMNA_RESISTANCE_SOFTCAP_SPEZIALISED_2_FOR_STRENGTH = 20;
    public static float STAIMNA_RESISTANCE_SCALE_1_SPEZIALISED_FOR_STRENGTH = 0f;
    public static float STAIMNA_RESISTANCE_SCALE_2_SPEZIALISED_FOR_STRENGTH = .05f;
    public static float STAIMNA_RESISTANCE_SCALE_3_SPEZIALISED_FOR_STRENGTH = 0.1f;
    public static float STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_SPEZIALISED_FOR_STRENGTH = STAIMNA_RESISTANCE_SOFTCAP_SPEZIALISED_1_FOR_STRENGTH * STAIMNA_RESISTANCE_SCALE_1_SPEZIALISED_FOR_STRENGTH;
    public static float STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_2_SPEZIALISED_FOR_STRENGTH = (STAIMNA_RESISTANCE_SOFTCAP_SPEZIALISED_2_FOR_STRENGTH - STAIMNA_RESISTANCE_SOFTCAP_SPEZIALISED_1_FOR_STRENGTH) + STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_SPEZIALISED_FOR_STRENGTH;

    public static float[] STM_RESIS_SCALES_SPEZIALISED_FOR_STREMGTH = { STAIMNA_RESISTANCE_SCALE_1_SPEZIALISED_FOR_STRENGTH, STAIMNA_RESISTANCE_SCALE_2_SPEZIALISED_FOR_STRENGTH, STAIMNA_RESISTANCE_SCALE_3_SPEZIALISED_FOR_STRENGTH };
    public static float[] STM_RESIS_BASES_SPEZIALISED_FOR_STREMGTH = { 0, STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_SPEZIALISED_FOR_STRENGTH, STAIMNA_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_2_SPEZIALISED_FOR_STRENGTH };
    ...
    //-----------SPEED_DEBUFF-----------SPEED_DEBUFF-----------SPEED_DEBUFF-----------SPEED_DEBUFF-----------SPEED_DEBUFF-----------SPEED_DEBUFF-----------SPEED_DEBUFF-----------SPEED_DEBUFF---------------

    public static int STARTVALUE_FOR_SPEED_DEBUFF_NOT_SPEZIALISED = 110;
    public static int SOFTCAP_FOR_SPEED_DEBUFF_NOT_SPEZIALISED_1 = 10;
    public static int SOFTCAP_FOR_SPEED_DEBUFF_NOT_SPEZIALISED_2 = 25;
    public static float SCALE_1_FOR_SPEED_DEBUFF_NOT_SPEZIALISED = 1.5f;
    public static float SCALE_2_FOR_SPEED_DEBUFF_NOT_SPEZIALISED = 1f;
    public static float SCALE_3_FOR_SPEED_DEBUFF_NOT_SPEZIALISED = 0.5f;
    public static int MAX_VALUE_AFTER_SOFTCAP_1_SPEED_DEBUFF_NOT_SPEZIALISED = Math.round(SOFTCAP_FOR_SPEED_DEBUFF_NOT_SPEZIALISED_1 * -SCALE_1_FOR_SPEED_DEBUFF_NOT_SPEZIALISED) + STARTVALUE_FOR_SPEED_DEBUFF_NOT_SPEZIALISED;
    public static int MAX_VALUE_AFTER_SOFTCAP_2_SPEED_DEBUFF_NOT_SPEZIALISED = Math.round((SOFTCAP_FOR_SPEED_DEBUFF_NOT_SPEZIALISED_2 - SOFTCAP_FOR_SPEED_DEBUFF_NOT_SPEZIALISED_1) * -SCALE_2_FOR_SPEED_DEBUFF_NOT_SPEZIALISED) + MAX_VALUE_AFTER_SOFTCAP_1_SPEED_DEBUFF_NOT_SPEZIALISED;

    public static float[] SPEED_DEBUFF_SCALES_NOT_SPEZIALISED = { SCALE_1_FOR_SPEED_DEBUFF_NOT_SPEZIALISED, SCALE_2_FOR_SPEED_DEBUFF_NOT_SPEZIALISED, SCALE_3_FOR_SPEED_DEBUFF_NOT_SPEZIALISED };
    public static int[] SPEED_DEBUFF_BASES_NOT_SPEZIALISED = { STARTVALUE_FOR_SPEED_DEBUFF_NOT_SPEZIALISED, MAX_VALUE_AFTER_SOFTCAP_1_SPEED_DEBUFF_NOT_SPEZIALISED, MAX_VALUE_AFTER_SOFTCAP_2_SPEED_DEBUFF_NOT_SPEZIALISED };

    public static int STARTVALUE_FOR_SPEED_DEBUFF_SPEZIALISED = 110;
    public static int SOFTCAP_FOR_SPEED_DEBUFF_SPEZIALISED_1 = 15;
    public static int SOFTCAP_FOR_SPEED_DEBUFF_SPEZIALISED_2 = 50;
    public static float SCALE_1_FOR_SPEED_DEBUFF_SPEZIALISED = .5f;
    public static float SCALE_2_FOR_SPEED_DEBUFF_SPEZIALISED = 1f;
    public static float SCALE_3_FOR_SPEED_DEBUFF_SPEZIALISED = 1.5f;
    public static int MAX_VALUE_AFTER_SOFTCAP_1_SPEED_DEBUFF_SPEZIALISED = Math.round(SOFTCAP_FOR_SPEED_DEBUFF_SPEZIALISED_1 * -SCALE_1_FOR_SPEED_DEBUFF_SPEZIALISED) + STARTVALUE_FOR_SPEED_DEBUFF_SPEZIALISED;
    public static int MAX_VALUE_AFTER_SOFTCAP_2_SPEED_DEBUFF_SPEZIALISED = Math.round((SOFTCAP_FOR_SPEED_DEBUFF_SPEZIALISED_2 - SOFTCAP_FOR_SPEED_DEBUFF_SPEZIALISED_1) * -SCALE_2_FOR_SPEED_DEBUFF_SPEZIALISED) + MAX_VALUE_AFTER_SOFTCAP_1_SPEED_DEBUFF_SPEZIALISED;

    public static float[] SPEED_DEBUFF_SCALES_SPEZIALISED = { SCALE_1_FOR_SPEED_DEBUFF_SPEZIALISED, SCALE_2_FOR_SPEED_DEBUFF_SPEZIALISED, SCALE_3_FOR_SPEED_DEBUFF_SPEZIALISED };
    public static int[] SPEED_DEBUFF_BASES_SPEZIALISED = { STARTVALUE_FOR_SPEED_DEBUFF_SPEZIALISED, MAX_VALUE_AFTER_SOFTCAP_1_SPEED_DEBUFF_SPEZIALISED, MAX_VALUE_AFTER_SOFTCAP_2_SPEED_DEBUFF_SPEZIALISED };

    //-----------MAX_LOAD-----------MAX_LOAD-----------MAX_LOAD-----------MAX_LOAD-----------MAX_LOAD-----------MAX_LOAD-----------MAX_LOAD-----------MAX_LOAD---------------

    public static int MAX_LOAD_STARTVALUE = 20;

    //-----------MAX_LOAD_FOR_Toughness-----------MAX_LOAD_FOR_Toughness-----------MAX_LOAD_FOR_Toughness-----------MAX_LOAD_FOR_Toughness-----------MAX_LOAD_FOR_Toughness-----------MAX_LOAD_FOR_Toughness-----------STAIMNA_RESISTANCE-----------STAIMNA_REGENERATION---------------
    ...
    //-----------MAX_LOAD_FOR_STRENGTH-----------MAX_LOAD_FOR_STRENGTH-----------MAX_LOAD_FOR_STRENGTH-----------MAX_LOAD_FOR_STRENGTH-----------MAX_LOAD_FOR_STRENGTH-----------MAX_LOAD_FOR_STRENGTH-----------STAIMNA_RESISTANCE-----------STAIMNA_REGENERATION---------------
    ...
    //-----------WEIGHT_RESISTANCE-----------WEIGHT_RESISTANCE-----------WEIGHT_RESISTANCE-----------WEIGHT_RESISTANCE-----------WEIGHT_RESISTANCE-----------WEIGHT_RESISTANCE-----------WEIGHT_RESISTANCE-----------WEIGHT_RESISTANCE---------------

    public static float WEIGHT_RESISTANCE_STARTVALUE_NOT_SPEZIALISED = 0.5f;
    public static float WEIGHT_RESISTANCE_STARTVALUE_SPEZIALISED = 0.5f;

    //-----------WEIGHT_RESISTANCE_FOR_RESISTANCE-----------WEIGHT_RESISTANCE_FOR_RESISTANCE-----------WEIGHT_RESISTANCE_FOR_RESISTANCE-----------WEIGHT_RESISTANCE_FOR_RESISTANCE-----------WEIGHT_RESISTANCE_FOR_RESISTANCE-----------WEIGHT_RESISTANCE_FOR_RESISTANCE-----------WEIGHT_RESISTANCE_FOR_RESISTANCE-----------WEIGHT_RESISTANCE_FOR_RESISTANCE---------------

    public static int WEIGHT_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_1_FOR_RESISTANCE = 15;
    public static int WEIGHT_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_2_FOR_RESISTANCE = 30;
    public static float WEIGHT_RESISTANCE_SCALE_1_NOT_SPEZIALISED_FOR_RESISTANCE = 0.5f;
    public static float WEIGHT_RESISTANCE_SCALE_2_NOT_SPEZIALISED_FOR_RESISTANCE = 0.25f;
    public static float WEIGHT_RESISTANCE_SCALE_3_NOT_SPEZIALISED_FOR_RESISTANCE = 0.1f;
    public static float WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_NOT_SPEZIALISED_FOR_RESISTANCE = (WEIGHT_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_1_FOR_RESISTANCE * WEIGHT_RESISTANCE_SCALE_1_NOT_SPEZIALISED_FOR_RESISTANCE) + WEIGHT_RESISTANCE_STARTVALUE_NOT_SPEZIALISED;
    public static float WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_2_NOT_SPEZIALISED_FOR_RESISTANCE = ((WEIGHT_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_2_FOR_RESISTANCE - WEIGHT_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_1_FOR_RESISTANCE) * WEIGHT_RESISTANCE_SCALE_2_NOT_SPEZIALISED_FOR_RESISTANCE) + WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_NOT_SPEZIALISED_FOR_RESISTANCE;

    public static float[] WEIGHT_RESISTANCE_SCALES_NOT_SPEZIALISED_FOR_RESISTANCE = { WEIGHT_RESISTANCE_SCALE_1_NOT_SPEZIALISED_FOR_RESISTANCE, WEIGHT_RESISTANCE_SCALE_2_NOT_SPEZIALISED_FOR_RESISTANCE, WEIGHT_RESISTANCE_SCALE_3_NOT_SPEZIALISED_FOR_RESISTANCE };
    public static float[] WEIGHT_RESISTANCE_BASES_NOT_SPEZIALISED_FOR_RESISTANCE = { WEIGHT_RESISTANCE_STARTVALUE_NOT_SPEZIALISED, WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_NOT_SPEZIALISED_FOR_RESISTANCE, WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_2_NOT_SPEZIALISED_FOR_RESISTANCE };

    public static int WEIGHT_RESISTANCE_SOFTCAP_SPEZIALISED_1_FOR_RESISTANCE = 10;
    public static int WEIGHT_RESISTANCE_SOFTCAP_SPEZIALISED_2_FOR_RESISTANCE = 50;
    public static float WEIGHT_RESISTANCE_SCALE_1_SPEZIALISED_FOR_RESISTANCE = 0.1f;
    public static float WEIGHT_RESISTANCE_SCALE_2_SPEZIALISED_FOR_RESISTANCE = 0.75f;
    public static float WEIGHT_RESISTANCE_SCALE_3_SPEZIALISED_FOR_RESISTANCE = 0.5f;
    public static float WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_SPEZIALISED_FOR_RESISTANCE = (WEIGHT_RESISTANCE_SOFTCAP_SPEZIALISED_1_FOR_RESISTANCE * WEIGHT_RESISTANCE_SCALE_1_SPEZIALISED_FOR_RESISTANCE) + WEIGHT_RESISTANCE_STARTVALUE_SPEZIALISED;
    public static float WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_2_SPEZIALISED_FOR_RESISTANCE = ((WEIGHT_RESISTANCE_SOFTCAP_SPEZIALISED_2_FOR_RESISTANCE - WEIGHT_RESISTANCE_SOFTCAP_SPEZIALISED_1_FOR_RESISTANCE) * WEIGHT_RESISTANCE_SCALE_2_SPEZIALISED_FOR_RESISTANCE) + WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_SPEZIALISED_FOR_RESISTANCE;

    public static float[] WEIGHT_RESISTANCE_SCALES_SPEZIALISED_FOR_RESISTANCE = { WEIGHT_RESISTANCE_SCALE_1_SPEZIALISED_FOR_RESISTANCE, WEIGHT_RESISTANCE_SCALE_2_SPEZIALISED_FOR_RESISTANCE, WEIGHT_RESISTANCE_SCALE_3_SPEZIALISED_FOR_RESISTANCE };
    public static float[] WEIGHT_RESISTANCE_BASES_SPEZIALISED_FOR_RESISTANCE = { WEIGHT_RESISTANCE_STARTVALUE_SPEZIALISED, WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_SPEZIALISED_FOR_RESISTANCE, WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_2_SPEZIALISED_FOR_RESISTANCE };
    //-----------WEIGHT_RESISTANCE_FOR_STRENGTH-----------WEIGHT_RESISTANCE_FOR_STRENGTH-----------WEIGHT_RESISTANCE_FOR_STRENGTH-----------WEIGHT_RESISTANCE_FOR_STRENGTH-----------WEIGHT_RESISTANCE_FOR_STRENGTH-----------WEIGHT_RESISTANCE_FOR_STRENGTH-----------WEIGHT_RESISTANCE_FOR_STRENGTH-----------WEIGHT_RESISTANCE_FOR_STRENGTH---------------

    public static int WEIGHT_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_1_FOR_STRENGTH = 15;
    public static int WEIGHT_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_2_FOR_STRENGTH = 30;
    public static float WEIGHT_RESISTANCE_SCALE_1_NOT_SPEZIALISED_FOR_STRENGTH = 0.5f;
    public static float WEIGHT_RESISTANCE_SCALE_2_NOT_SPEZIALISED_FOR_STRENGTH = 0.25f;
    public static float WEIGHT_RESISTANCE_SCALE_3_NOT_SPEZIALISED_FOR_STRENGTH = 0.1f;
    public static float WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_NOT_SPEZIALISED_FOR_STRENGTH = (WEIGHT_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_1_FOR_STRENGTH * WEIGHT_RESISTANCE_SCALE_1_NOT_SPEZIALISED_FOR_STRENGTH) + WEIGHT_RESISTANCE_STARTVALUE_NOT_SPEZIALISED;
    public static float WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_2_NOT_SPEZIALISED_FOR_STRENGTH = ((WEIGHT_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_2_FOR_STRENGTH - WEIGHT_RESISTANCE_SOFTCAP_NOT_SPEZIALISED_1_FOR_STRENGTH) * WEIGHT_RESISTANCE_SCALE_2_NOT_SPEZIALISED_FOR_STRENGTH) + WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_NOT_SPEZIALISED_FOR_STRENGTH;

    public static float[] WEIGHT_RESISTANCE_SCALES_NOT_SPEZIALISED_FOR_STRENGTH = { WEIGHT_RESISTANCE_SCALE_1_NOT_SPEZIALISED_FOR_STRENGTH, WEIGHT_RESISTANCE_SCALE_2_NOT_SPEZIALISED_FOR_STRENGTH, WEIGHT_RESISTANCE_SCALE_3_NOT_SPEZIALISED_FOR_STRENGTH };
    public static float[] WEIGHT_RESISTANCE_BASES_NOT_SPEZIALISED_FOR_STRENGTH = { 0, WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_NOT_SPEZIALISED_FOR_STRENGTH, WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_2_NOT_SPEZIALISED_FOR_STRENGTH };

    public static int WEIGHT_RESISTANCE_SOFTCAP_SPEZIALISED_1_FOR_STRENGTH = 10;
    public static int WEIGHT_RESISTANCE_SOFTCAP_SPEZIALISED_2_FOR_STRENGTH = 50;
    public static float WEIGHT_RESISTANCE_SCALE_1_SPEZIALISED_FOR_STRENGTH = 0.1f;
    public static float WEIGHT_RESISTANCE_SCALE_2_SPEZIALISED_FOR_STRENGTH = 0.75f;
    public static float WEIGHT_RESISTANCE_SCALE_3_SPEZIALISED_FOR_STRENGTH = 0.5f;
    public static float WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_SPEZIALISED_FOR_STRENGTH = (WEIGHT_RESISTANCE_SOFTCAP_SPEZIALISED_1_FOR_STRENGTH * WEIGHT_RESISTANCE_SCALE_1_SPEZIALISED_FOR_STRENGTH) + WEIGHT_RESISTANCE_STARTVALUE_SPEZIALISED;
    public static float WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_2_HP_SPEZIALISED_FOR_STRENGTH = ((WEIGHT_RESISTANCE_SOFTCAP_SPEZIALISED_2_FOR_STRENGTH - WEIGHT_RESISTANCE_SOFTCAP_SPEZIALISED_1_FOR_STRENGTH) * WEIGHT_RESISTANCE_SCALE_2_SPEZIALISED_FOR_STRENGTH) + WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_SPEZIALISED_FOR_STRENGTH;

    public static float[] WEIGHT_RESISTANCE_SCALES_SPEZIALISED_FOR_STRENGTH = { WEIGHT_RESISTANCE_SCALE_1_SPEZIALISED_FOR_STRENGTH, WEIGHT_RESISTANCE_SCALE_2_SPEZIALISED_FOR_STRENGTH, WEIGHT_RESISTANCE_SCALE_3_SPEZIALISED_FOR_STRENGTH };
    public static float[] WEIGHT_RESISTANCE_BASES_SPEZIALISED_FOR_STRENGTH = { 0, WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_1_SPEZIALISED_FOR_STRENGTH, WEIGHT_RESISTANCE_MAX_VALUE_AFTER_SOFTCAP_2_HP_SPEZIALISED_FOR_STRENGTH };
    ...
    public static int MINIMUM_SWAG_1 = 20;
    public static int MINIMUM_SWAG_2 = 30;
